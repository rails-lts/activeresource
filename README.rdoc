...
This is a fork of Rails' official {active-resource gem}[https://github.com/rails/activeresource], compatible with Rails 4.2 (LTS), with backportet security fixes for:
...
To use it, you need to add it to the Gemfile like this:
  ...
  gem 'activeresource', git: 'https://github.com/rails-lts/activeresource.git', branch: 'lts-4'
